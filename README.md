...
| Web search | DuckDuckGo HTML endpoint | No API key needed on any free tier. Scoped queries (`"<company> interview process" site:reddit.com …`). Degrades to an empty result set rather than failing the run. |
